    ...
    <ul class="row flex flex-wrap justify-around list-unstyled">
      <li class="col-4 px-3 ">
          <div class="cnt-block equal-hight border-red-500 border-1 rounded shadow " >
            ...
            <h3 ><a href="http://www.webcoderskull.com/" style="color:#fc4a1a">Web coder skull</a></h3>
            <p>Armed Robber</p>
           
            <h3 ><a href="http://www.webcoderskull.com/" class="text-green-500 bold">Reward: Ksh. 1M</a></h3>
      ...
      <li class="col-4 px-3">
          <div class="cnt-block equal-hight border-red-500 " >
            <figure><img src="http://www.webcoderskull.com/img/team4.png" class="img-responsive" alt=""></figure>
            <h3 ><a href="http://www.webcoderskull.com/" style="color:#fc4a1a">Web coder skull</a></h3>
            <p>Armed Robber</p>
      ...
      <li class="col-4 px-3 ">
          <div class="cnt-block equal-hight border-red-500 border-1 rounded shadow px-3" >
            <figure><img src="http://www.webcoderskull.com/img/team4.png" class="img-responsive card-img-top" alt="" ></figure>
            <h3 class="my-2" >NAME: <a href="http://www.webcoderskull.com/" class="uppercase bolder my-2" style="color:#fc4a1a">Web coder skull</a></h3>
            <p class="my-2">Comes From:<strong>Meru County</strong></p>
           
            <h3 >Got Lost:<a href="http://www.webcoderskull.com/" class="text-green-500 bold">10 days Ago</a></h3>
      ...
      <li class="col-4 px-3 ">
          <div class="cnt-block equal-hight border-red-500 border-1 rounded shadow px-3" >
            <figure><img src="http://www.webcoderskull.com/img/team3.png" class="img-responsive card-img-top" alt="" ></figure>
            <h3 class="my-2" >NAME: <a href="http://www.webcoderskull.com/" class="uppercase bolder my-2" style="color:#fc4a1a">Web coder skull</a></h3>
            <p class="my-2">Comes From:<strong>Meru County</strong></p>
      ...
      <li class="col-4 px-3 ">
          <div class="cnt-block equal-hight border-red-500 border-1 rounded shadow px-3" >
            <figure><img src="http://www.webcoderskull.com/img/team2.png" class="img-responsive card-img-top" alt="" ></figure>
            <h3 class="my-2" >NAME: <a href="http://www.webcoderskull.com/" class="uppercase bolder my-2" style="color:#fc4a1a">Web coder skull</a></h3>
            <p class="my-2">Comes From:<strong>Meru County</strong></p>
      ...
      <li class="col-4 px-3 ">
          <div class="cnt-block equal-hight border-red-500 border-1 rounded shadow px-3" >
            <figure><img src="http://www.webcoderskull.com/img/team1.png" class="img-responsive card-img-top" alt=""></figure>
            <h3 class="my-2" >NAME: <a href="http://www.webcoderskull.com/" class="uppercase bolder my-2" style="color:#fc4a1a">Web coder skull</a></h3>
            <p class="my-2">Comes From:<strong>Meru County</strong></p>
