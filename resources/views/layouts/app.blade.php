...
<body>
    <div id="app px-4">
      ...
      <footer id="sticky-footer" class="py-4 bg-dark text-white-50"  style=" background: linear-gradient(to right, #fc4a1a, #f7b733);">
        <div class="h-5"></div>
    <div class="container text-center">
      <small>Copyright &copy; Crime Reporting Sytem 2020</small>
    </div>
     <div class="h-5"></div>
  </footer>
</body>
